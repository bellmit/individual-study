...
import cn.gyw.backend.components.common.model.ApiLog;
...
public class ApiRespAspect {
    ...
    @Pointcut("execution(* cn.gyw..controller.*.*(..)) && target(cn.gyw.backend.components.common.base.mgb.BaseController)")

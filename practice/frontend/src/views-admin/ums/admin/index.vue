    ...
    methods: {
      ...
      handleDelete(index, row) {
        this.$confirm('是否要删除该用户?', '提示', {
          ...
          sysUserApi.remove(row.id).then(response => {
            this.$message({
              type: 'success',
              message: '删除成功!'
            });
      ...
      handleDialogConfirm() {
        this.$confirm('是否要确认?', '提示', {
          ...
          if (this.isEdit) {
            sysUserApi.patch(this.admin).then(response => {
              this.$message({
                message: '修改成功！',
                type: 'success'
              });
            ...
            sysUserApi.offer(this.admin).then(response => {
              this.$message({
                message: '添加成功！',
                type: 'success'
              });
      ...
      handleAllocDialogConfirm(){
        this.$confirm('是否要确认?', '提示', {
          ...
          sysUserApi.allocRole(params).then(response => {
            this.$message({
              message: '分配成功！',
              type: 'success'
            });
      ...
      getList() {
        ...
        sysUserApi.findByPage(this.listQuery).then(response => {

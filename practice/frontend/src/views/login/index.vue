      ...
      <!-- <el-form-item label="验证码：" prop="verifyCode">
        <el-row>
          <el-col id="VerifyCodeImage" :span="7">
            <el-image @click="refreshVerifyCodeImage" :src="verifyCodeImage.url" :title="verifyCodeImage.title" />
          </el-col>
          <el-col :span="7">
  ...
  export default {
    ...
    data() {
      ...
      return {
        ...
        redirect: undefined,
        verifyCodeImage: {
          url: 'http://127.0.0.1:8089/api/verifyImage?' + Math.random(),
          title: '点击刷新！'
        }
    ...
    mounted() {
      this.verifyCodeImage.url = 'http://127.0.0.1:8089/api/verifyImage?' + Math.random()
    }
  }
</script>
